...
namespace Qlt.MsDataverse.Extensions
{
    public static class HttpRequestExtensions
    {
        ...
        public static HttpContent Clone(this HttpContent content)
        {
            ...
            {
                StringContent sc => new StringContent(sc.ReadAsStringAsync().Result),
                _ => throw new ServiceException($"{content.GetType()} Content type not implemented for HttpContent.Clone extension method."),
            };
            clone.Headers.Clear();
